        ...
        if result.returncode == 0:
            ...
            if os_type == "Windows":
                ...
                if "RUNNING" in service_result.stdout:
                    ...
                    print(
                        Fore.RED + "Le service Docker n'est pas actif. Vous devez exécuter le script en tant qu'administrateur." + Style.RESET_ALL)
            ...
            print(
                Fore.RED + "Docker n'est pas installé. Vous pouvez le télécharger ici : https://www.docker.com/get-started" + Style.RESET_ALL)
